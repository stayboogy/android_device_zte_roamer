...
#Audio
unzip -j -o ../../../${DEVICE}_update.zip system/lib/libaudio.so -d ../../../vendor/zte/$DEVICE/proprietary/
#Wifi
unzip -j -o ../../../${DEVICE}_update.zip system/lib/dhd.ko -d ../../../vendor/zte/$DEVICE/proprietary/
